      ...
      <main className={styles.left}>
        ...
        <ul className={styles.left__list}>
          ...
          <li className={styles.left__list_item}>
            ...
            <p className={styles.left__list_item__text}>
              As per guidelines of SEBI, all customers of a Bank or waller, who
              wish to avail higher balance of ability to transfer money needs to
              complete KYC.
            </p>
          </li>
          <li className={styles.left__list_item}>
            ...
            <p className={styles.left__list_item__text}>
              ...
              identify theft, prevent terrorist financing, money laundering and
              financial fraud. KYC allows us to understand the customer better
              and manage risks prudently.
            </p>
          </li>
        </ul>
        <Button size="large" className={clsx(styles.btn_contained, styles.btn)}>
          View More
        </Button>
      </main>
    </section>
